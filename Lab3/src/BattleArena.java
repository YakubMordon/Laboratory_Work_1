...
public class BattleArena {
     ...
     boolean fight(int length){
          ...
          try {
               ...
               while (true) {
                    ...
                    initFighters(indicator, count1, count2, numb1, numb2);
                    action(myWriter);
                    ...
                    if (count1 == 1 && count2 == 1) {
                         ...
                         swap(indicator, numb1, numb2, count1, count2);
     ...
     private void initFighters(boolean indicator, int count1,int count2, int numb1, int numb2){
     ...
     private void swap(boolean indicator,int numb1,int numb2,int count1, int count2){
          if(!defender.isAlive()){
     ...
     private void action(FileWriter myWriter){
          ...
          try {
               ...
               if(rand < 5) {
                    ...
                    System.out.println("\nСтало здоров'я у дроїда " + this.defender.name + " - " + this.defender.health);
                    myWriter.write("\nСтало здоров'я у дроїда " + this.defender.name + " - " + this.defender.health + "\n");
               }
               else if(rand > 7) {
